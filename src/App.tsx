          ...
          <div className="flex items-center gap-3 group">
            <div className="relative">
              <img 
                src="/logo.png?v=2.5" 
                alt="DICON" 
                className="h-20 w-auto w-auto transition-transform group-hover:scale-110"
                onError={(e) => {
        ...
        <div className="section-container relative z-10">
          ...
          >
            {[
              ...
              { id: "maquila", title: "Industria Maquiladora", desc: "Acero especial, tornillería industrial, EPP y herramientas de precisión.", icon: "🏭", color: "from-purple-500/20" }
     {/* FAQ Section */}
