      ...
      <section id="industrial" className="py-32 relative bg-bg border-t border-white/5 overflow-hidden" style={{ contentVisibility: 'auto' } as any}>
        ...
        <div className="section-container relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
              ...
              >
                <div className="w-20 h-2 bg-accent mb-8 shadow-[0_0_20px_rgba(249,115,22,0.5)]" />
                <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-8 italic">Catálogo de <br/> <span className="text-white/40 font-normal">Aceros Especiales</span></h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <motion.div 
                    ...
                    className="space-y-6"
                  >
                    <p className="text-accent font-black text-xs uppercase tracking-[4px] flex items-center gap-2">
                       <span className="w-2 h-2 bg-accent rounded-full animate-pulse" /> Especiales y Aleados
                    </p>
                    <ul className="space-y-4 text-white/60 text-sm font-medium">
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Aceros al Carbón</li>
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Inoxidable Serie 300/400</li>
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Grado Herramienta</li>
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Placa Antiderrapante</li>
                    </ul>
                  </motion.div>
                  <motion.div 
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <p className="text-accent font-black text-xs uppercase tracking-[4px] flex items-center gap-2">
                       <span className="w-2 h-2 bg-accent rounded-full animate-pulse" /> Perfiles Comerciales
                    </p>
                    <ul className="space-y-4 text-white/60 text-sm font-medium">
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Viga IPR / HSS</li>
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Perfil PTR / Canal G</li>
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Varilla Corrugada</li>
                      <li className="flex items-center gap-2 hover:text-white transition-colors group cursor-default"><ArrowRight className="w-3 h-3 text-accent group-hover:translate-x-1 transition-transform" /> Lámina Pintro/Zinc</li>
                    </ul>
                  </motion.div>
                </div>
                <button 
              ...
              <motion.div 
                ...
                className="relative rounded-[50px] overflow-hidden border border-white/10 bg-black aspect-square flex items-center justify-center group shadow-2xl"
              >
                 <div className="absolute inset-0 bg-accent/20 mix-blend-color group-hover:bg-accent/10 transition-colors duration-700 z-10" />
                 <img src="/herramientas.png" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" alt="Herramientas" />
                 ...
                 <div className="absolute bottom-12 left-12 right-12 z-30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 translate-y-4 group-hover:translate-y-0">
                    <p className="text-accent font-black text-[10px] uppercase tracking-[5px] mb-2">Suministro Premium</p>
                    <p className="text-white font-bold text-xl uppercase italic">Calidad Certificada</p>
                 </div>
              </motion.div>
          </div>
